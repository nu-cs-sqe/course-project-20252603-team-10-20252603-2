...
| 2           | supported= value contains more than one locale code, e.g. en,es,fr                                 | returns the same number of LanguageOptions as locale codes listed in languages.properties                                                                                 | yes           |
| 3           | current supported= value contains at least two locale codes                                        | returned list contains at least two language choices                                                                                                                      | yes           |
| 4           | each locale code listed in the fixed supported= property has a matching messages_locale.properties | loading supported languages completes without a missing bundle exception                                                                                                  | yes           |
| 5           | every fixed messages_locale.properties contains language.name                                      | each LanguageOption has non-empty display name                                                                                                                            | yes           |
| 6           | Fixed supported= value lists English                                                               | returned list contains a LanguageOption for english                                                                                                                       | yes           |
| 7           | Fixed supported= value lists Spanish                                                               | returned list contains a LanguageOption for spanish                                                                                                                       | yes           |
| 8           | Fixed supported= value lists French                                                                | returned list contains a LanguageOption for french                                                                                                                        | yes           |
| 9           | Fixed supported= value has an order, e.g. en,es,fr                                                 | returned LanguageOption s that preserve the same order as the config file                                                                                                 | yes           |
| 10          | Fixed locale codes are converted with Locale.forLanguageTag(code.trim())                           | returned LanguageOption locales matching Locale.forLanguageTag(...) for each configured code                                                                              | yes           |
...
| 12          | supported is empty, e.g. supported=                                                                | CAN'T SET with the real fixed files; documented invalid configuration case; Current production resources should never be empty.                                           | not automated |
...
| 14          | supported contains duplicate locale codes, e.g. en,en                                              | CAN'T SET with the real fixed files; documented duplicate-contents boundary; Duplicate handling is not specified because production config should not contain duplicates. | not automated |
...
|-------------|-------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|---------------|
| 1           | Current fixed config has a non-empty supported language list            | Call getSupportedLanguages()                                                                   | Returns a non-empty list of LanguageOptions                                               | yes           |
| 2           | Current fixed config has more than one supported language               | Call getSupportedLanguages()                                                                   | Returns more than 1 LanguageOption                                                        | yes           |
| 3           | Current fixed config supports at least two languages                    | Call getSupportedLanguages()                                                                   | Returned list size is at least 2, supporting the A-level locale requirement               | yes           |
| 4           | Current fixed config includes English                                   | Call getSupportedLanguages()                                                                   | Returned list contains English language option                                            | yes           |
| 5           | Current fixed config includes Spanish                                   | Call getSupportedLanguages()                                                                   | Returned list contains Spanish language option                                            | yes           |
| 6           | Current fixed config includes French                                    | Call getSupportedLanguages()`                                                                  | Returned list contains French language option                                             | yes           |
| 7           | Current fixed config lists languages in a specific order                | Call getSupportedLanguages()`                                                                  | Returned list preserves the configured order                                              | yes           |
| 8           | Current fixed config has three preset languages at the time of writing  | Call getSupportedLanguages()                                                                   | Returned list size equals the number of configured locale codes, not a hardcoded number   | yes           |
| 9           | Current fixed config is valid                                           | Call getSupportedLanguages() twice                                                             | Returns two different list objects with equivalent contents                               | yes           |
| 10          | Current fixed config is valid                                           | Call getSupportedLanguages(), clear the returned list, then call getSupportedLanguages() again | Internal supportedLanguages list is unchanged because the method returns a defensive copy | yes           |
| 11          | Current fixed config is valid                                           | Call getSupportedLanguages(), add a fake LanguageOption, then call the getter again            | Internal supportedLanguages list does not include the fake language option                | yes           |
